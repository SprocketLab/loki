...
if __name__ == '__main__':
    ...
    print(f"error%: {(prediction_w_label_model!=y_true).mean()}")
    print(f"% relative improvement {(tree_dist_hierarcy_tree - argmax_dist_hierarchy_tree)/argmax_dist_hierarchy_tree}")
    print("")
    ...
    print(f"error%: {(prediction_w_label_model!=y_true).mean()}")
    print(f"% relative improvement {(tree_dist_pc_tree - argmax_dist_pc_tree)/argmax_dist_pc_tree}")
    print("")
    ...
    print(f"argmax prediction + random tree dist: {argmax_dist_random_tree}")
    print(f"random tree prediction + random tree dist: {tree_dist_random_tree}")
    print(f"error%: {(prediction_w_label_model!=y_true).mean()}")
    print(f"% relative improvement {(tree_dist_random_tree-argmax_dist_random_tree)/argmax_dist_random_tree}")